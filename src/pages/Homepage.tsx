        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Book exceptional private chefs for any occasion - from weekly meal prep to elegant dinner parties
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="relative">
                ...
                <div className="pl-10 h-12 border rounded-md flex items-center justify-between px-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="w-6 text-center text-sm">{kids}</span>
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-6 w-6 p-0"
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="w-6 text-center text-sm">{pets}</span>
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-6 w-6 p-0"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {recommendations.map((item) => (
              <Card key={item.id} className="group cursor-pointer hover:shadow-lg transition-shadow duration-300">
                <div className="relative overflow-hidden rounded-t-lg">
                  <img
                    src={item.image}
                    alt={item.title}
      ...
      <footer className="bg-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center">
            <p className="text-white/80">&copy; 2024 MonCuisinierPrivé. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
